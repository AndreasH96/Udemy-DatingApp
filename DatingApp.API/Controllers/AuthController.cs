...
namespace DatingApp.API.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        {
            //Checks that the user exists and password is correct
            ...
            //Starts building token, will contain two claims
            var claims = new[]{
                //Users ID
